    ...
    <div className="min-h-screen bg-black text-white">
      <div className="max-w-7xl mx-auto px-5 py-16 space-y-20">
        ...
        <motion.section
          ...
          className="rounded-[30px] border border-white/5 bg-gradient-to-br from-[#0a0a14] to-black p-8 lg:p-12"
        >
          <div className="grid lg:grid-cols-12 gap-10 items-center">

            {/* LEFT */}
            <div className="lg:col-span-7 space-y-6">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-blue-600/10 border border-blue-500/20 text-xs font-black uppercase tracking-widest text-blue-400">
                <Sparkles size={14} />
                Premium Learning
              </div>
              ...
              <div className="flex flex-wrap gap-3 pt-2">
                {["Verified Tutors", "Flexible Schedule", "Live Sessions"].map((item) => (
                  <div
                    key={item}
                    className="flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 border border-white/10 text-xs font-bold text-zinc-300"
                  >
            ...
            <div className="lg:col-span-5">
              ...
              >
                ...
                <div className="mt-5 flex justify-between items-center bg-black/20 rounded-xl px-4 py-3 border border-white/10">
        ...
        <section>
          <div className="mb-10 flex flex-col md:flex-row md:items-end justify-between gap-4">
            <div>
              <p className="text-xs uppercase tracking-widest text-blue-500 font-black mb-2">
                Features
              </p>
            ...
            <p className="text-sm text-zinc-400 max-w-md md:text-right">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {services.map((service, index) => (
              <motion.div
                ...
                className="group p-6 rounded-3xl border border-white/5 bg-[#0a0a14] hover:border-blue-500/20 hover:shadow-lg hover:shadow-blue-500/10 transition-all duration-300"
              >
                <div className="flex justify-between items-center mb-5">
                  <div className="w-14 h-14 flex items-center justify-center rounded-xl bg-blue-600/10 text-blue-500 group-hover:bg-blue-600 group-hover:text-white transition-all">
                    {service.icon}
                  </div>
                  <span className="text-xs text-zinc-700 font-black">
                    0{index + 1}
                  </span>
                </div>
